...
CREATE TABLE ckout.vfile(
  ...
  chnged INT DEFAULT 0,             -- Encoded in fsl_vfile_change_e enum.
                                    -- 0:unchnged 1:edited 2:m-chng 3:m-add 4:i-chng 5:i-add
                                    -- 6:+x but unmodified, 7:changed to symlink but unmodified
                                    -- 8:-x but unmodified, 9:changed to not symlink but unmodified
