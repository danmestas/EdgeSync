...
*/
FSL_EXPORT int fsl_config_set_text( fsl_cx * const f, fsl_confdb_e mode,
...
/**
   ...
   returns the result of fsl_db_txn_end() and propagates
...
/**
   ...
   skipped over (e.g. if 'c' is provided but no checkout is opened,
