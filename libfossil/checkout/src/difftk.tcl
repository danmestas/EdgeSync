# This script was taken verbatim from the Fossil SCM project.  It is
# not standalone: it is intended to be embedded in output generated by
# f-vdiff (or similar).
set prog {
package require Tk
...
proc readDiffs {fossilcmd} {
  ...
  set n1 0
  set n2 0  
  array set widths {txt 3 ln 6 mkr 1}
