...
#if 0
/* This code was originally built to be either compiled in or dynamically
   loaded. This libfossil project does not dynamically load it, so does not
   need sqlite3ext.h, but this block is retained for some hypothetical future
   reuse. */
#  ifndef SQLITE_CORE
